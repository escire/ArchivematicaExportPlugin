<?php
require_once realpath('.') . '/plugins/generic/sword/libs/swordappv2/packager_mets_swap.php';
...
class PackageWrapper extends PKPPackagerMetsSwap{
     ...
     */
      function writeHeader($fh) {
        ...
        fwrite($fh, "<mets ID=\"sort-mets_mets\" OBJID=\"sword-mets\" LABEL=\"" . $this->getLabel() . "\" PROFILE=\"OJS METS SIP Profile 1.0\" xmlns=\"http://www.loc.gov/METS/\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.loc.gov/METS/ http://www.loc.gov/standards/mets/mets.xsd\">\n");
